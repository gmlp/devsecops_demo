    ...
    stages {
        stage('Test & Build'){
          ...
          steps{
            parallel(
                Step1:  {
                    buildDockerImage "${readProperties.registry}/spring-app-vault",
        ...
        stage('Publish Image'){
            ...
            steps {
                pushDockerImage "${readProperties.registry}/spring-app-vault"
        ...
        stage('deploy app'){
            ...
            steps {
                stackRollout readProperties.stackName, readProperties.stackFile, "stacks"
            }
